...
3. **$$Y_ii$$**: This is the **output sequence at time step $$i$$**. $$Y_ii$$ is actually a **probability distribution over the entire vocabulary** generated by using a **softmax activation**. Thus, each $$Y_ii$$ is a **vector of size `vocab_size`**, representing a probability distribution
